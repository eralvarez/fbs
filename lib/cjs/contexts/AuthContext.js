...
const AuthProvider = ({ firebaseConfig, children }) => {
    const { user, hasAuth, authLoading, isAnonymous, app, auth, handleSignInAnonymously, handleSignOut, handleSignInWithEmailAndPassword, } = (0, useAuth_1.useAuth)({ firebaseConfig });
